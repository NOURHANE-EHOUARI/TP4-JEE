...
<body>
    ...
    <nav>
        ...
        <div class="nav-right">
            <span class="nav-user">Connecte : <strong>${utilisateur.login}</strong></span>
        ...
        <c:if test="${utilisateur.role == 'ADMIN'}">
            <div class="card">
                <div class="card-title">
                    <c:if test="${produitEdit != null}">Modifier le produit</c:if>
                    <c:if test="${produitEdit == null}">Ajouter un produit</c:if>
                </div>
                <form action="${produitEdit != null ? 'updateProduit' : 'addProduit'}" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <button type="submit" class="btn-primary">
                            <c:if test="${produitEdit != null}">Modifier</c:if>
                            <c:if test="${produitEdit == null}">Ajouter</c:if>
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="card">
            ...
            <form action="listProduits" method="get">
                <div class="form-row">
                    ...
                    <button type="button" class="btn-secondary" onclick="window.location='listProduits'">Tout afficher</button>
                </div>
            </form>
        </div>
                ...
                <tbody>
                    <c:forEach var="p" items="${listeProduits}">
                        <tr>
                            ...
                            <td>
                                <c:if test="${utilisateur.role == 'ADMIN'}">
                                    <a href="editProduit?id=${p.idProduit}" class="btn-edit">Modifier</a>
                                    <a href="deleteProduit?id=${p.idProduit}" class="btn-delete"
